...
export default function NewCustomer() {
  ...
  // Form state
  const [firstName, setFirstName] = useState(actionData?.formData?.firstName || "");
  const [lastName, setLastName] = useState(actionData?.formData?.lastName || "");
  const [email, setEmail] = useState(actionData?.formData?.email || "");
  const [phone, setPhone] = useState(actionData?.formData?.phone || "");
  const [address1, setAddress1] = useState(actionData?.formData?.address1 || "");
  const [address2, setAddress2] = useState(actionData?.formData?.address2 || "");
  const [city, setCity] = useState(actionData?.formData?.city || "");
  const [state, setState] = useState(actionData?.formData?.state || "");
  const [pincode, setPincode] = useState(actionData?.formData?.pincode || "");
  const [gstin, setGstin] = useState(actionData?.formData?.gstin || "");
  const [notes, setNotes] = useState(actionData?.formData?.notes || "");
  const [tags, setTags] = useState(actionData?.formData?.tags || "");
